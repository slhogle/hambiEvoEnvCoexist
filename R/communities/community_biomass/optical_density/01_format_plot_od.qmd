...
### Pairs *without* first growth cycle
...
#| fig-width: 7
#| fig-height: 11
plot_od_grid(pairs_combo_f, remove_first_cycle = FALSE, ncol = 4)
```
...
### Trios *without* first growth cycle
...
#| fig-width: 7
#| fig-height: 14
plot_od_grid(trios_combo_f, remove_first_cycle = FALSE, ncol = 4)
```
...
### Quartets *without* first growth cycle
...
## Octets (all strains of all species)

### Octets *without* first growth cycle
...
#| warning: false
#| echo: false
plot_od_octets(eights_combo_f, remove_first_cycle = FALSE, ncol=4)
```
As in @fig-07 but including data from the first growth cycle.
:::
