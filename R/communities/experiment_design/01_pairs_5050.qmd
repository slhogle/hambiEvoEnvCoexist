...
```{r}
my_colors <- c(
  "ANC_0403_10" = "#ffaaaa", "ANC_0403_50" = "#aa0000", "ANC_0403_70" = "#aa0000", "ANC_0403_80" = "#aa0000", "ANC_0403_90" = "#aa0000", 
  "ANC_1287_10" = "#ffeeaa", "ANC_1287_50" = "#d4aa00", "ANC_1287_70" = "#d4aa00", "ANC_1287_80" = "#d4aa00", "ANC_1287_90" = "#d4aa00", 
  "ANC_1896_10" = "#ccffaa", "ANC_1896_50" = "#44aa00", "ANC_1896_70" = "#44aa00", "ANC_1896_80" = "#44aa00", "ANC_1896_90" = "#44aa00", 
  "ANC_1977_10" = "#aaccff", "ANC_1977_50" = "#0055d4", "ANC_1977_70" = "#0055d4", "ANC_1977_80" = "#0055d4", "ANC_1977_90" = "#0055d4",
  "EVO_0403_10" = "#ffaaee", "EVO_0403_50" = "#ff00cc", "EVO_0403_70" = "#ff00cc", "EVO_0403_80" = "#ff00cc", "EVO_0403_90" = "#ff00cc", 
  "EVO_1287_10" = "#ffccaa", "EVO_1287_50" = "#ff6600", "EVO_1287_70" = "#ff6600", "EVO_1287_80" = "#ff6600", "EVO_1287_90" = "#ff6600", 
  "EVO_1896_10" = "#aaffee", "EVO_1896_50" = "#00ffcc", "EVO_1896_70" = "#00ffcc", "EVO_1896_80" = "#00ffcc", "EVO_1896_90" = "#00ffcc", 
  "EVO_1977_10" = "#ccaaff", "EVO_1977_50" = "#7f2aff", "EVO_1977_70" = "#7f2aff", "EVO_1977_80" = "#7f2aff", "EVO_1977_90" = "#7f2aff"
  )
```
...
```{r}
# all combinations in 50/50. This was added 27.3.25
combos02_filt_well_5050 <- combos02_filt %>% 
  mutate(a = paste(a, 50, sep = "_"), 
         b = paste(b, 50, sep = "_")) %>% 
  add_count(a, name = "a_count") %>% 
  add_count(b, name = "b_count") %>% 
  arrange(desc(a_count), a) %>% 
...
```{r}
bind_rows(combos02_filt_well_5050, combos02_filt_well) %>%
  group_by(a, b) %>% 
...
#| fig.height: 5
#| echo: false
plate_plot_steps(combos02_filt_well, well, a, "Pairs 90/10: Step 1", my_colors)
```
...
#| fig.height: 5
#| echo: false
plate_plot_steps(combos02_filt_well, well, b, "Pairs 90/10: Step 2", my_colors)
```
...
# Pipetting 50/50 pairs

This must be done in a separate plate because it was done after the initial batch of 90/10 pairs. Proceed in the order of steps below to construct master plates used to inoculate different conditions
...
#| fig.height: 5
#| echo: false
plate_plot_steps(combos02_filt_well_5050, well, a, "Pairs 50/50: Step 1", my_colors)
```
Layout for the first pipetting step for constructing pairs. Different colors show different species/evolution combinations. Both strains/species are added in ~ 50/50 proportion.
:::
...
#| fig.height: 5
#| echo: false
plate_plot_steps(combos02_filt_well_5050, well, b, "Pairs 50/50: Step 2", my_colors)
```
Layout for the second pipetting step for constructing pairs. Different colors show different species/evolution combinations. Both strains/species are added in ~ 50/50 proportion.
:::